...
# df.plot()
# plt.ylabel("Кол-во велосепидистов (в час)")
# plt.show()

# weekly = df.resample("W").sum()
# weekly.plot(style=["-", ":", "--"])
# plt.ylabel("Кол-во велосепидистов (по неделям)")
# plt.show()
...
# plt.ylabel("Среднее месячное кол-во велосепидистов (скользящее окно)")
# plt.show()
...
# plt.sho() # !должно быть в единственном экземпляре
