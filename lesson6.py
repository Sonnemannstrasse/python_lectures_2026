...
x = pd.Series([True, False, False, True], dtype="boolean")
print(x)
x[0] = None
x[1] = np.nan
print(x)
...
# how = all - убрать, если хотя бы одно отсутствует
...
# одномерный массив Series может хранить данные с большим числом измерений 
